    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="文章详情" prop="wenzhangxiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.wenzhangxiangqing" label="文章详情" prop="wenzhangxiangqing">
                    <span v-html="ruleForm.wenzhangxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.wenzhangxiangqing = this.ruleForm.wenzhangxiangqing.replace(reg,'../../../springbootp89xk/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `wenzhangfenxiang/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.wenzhangfenxiangCrossAddOrUpdateFlag = false;
						 this.parent.search();
